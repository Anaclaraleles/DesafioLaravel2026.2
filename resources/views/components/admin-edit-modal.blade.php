        ...
        <form action="{{ route('admin.edit', $admin) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-3 gap-3 mb-4">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="balance" value="{{ old('balance', $admin->balance) }}" class="w-full bg-white border border-gray-300 rounded-md px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#4E6E6E]"/>
                    @error('balance')
                        <span class="text-xs text-red-500">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex justify-center gap-4 mt-8">
                <button type="button" @click="editingAdminId = null" class="px-8 py-3 border-1 rounded-lg bg-[#C7D6D4] text-[#3a5555] font-medium hover:bg-[#b7c9c6] transition cursor-pointer shadow-lg shadow-[#4E6E6E]">Cancelar</button>
