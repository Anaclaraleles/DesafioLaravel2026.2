        ...
        <form action="{{ route('user.create') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-3 mb-4">
                ...
                <div>
                    ...
                    <input name="complement" value="{{ old('complement') }}" class="w-full bg-white border border-gray-300 rounded-md px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#4E6E6E]"/>
                    @error('complement')
                        <span class="text-xs text-red-500">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-3 gap-3 mb-4">
                <div>
                    ...
                    <input name="number" value="{{ old('number') }}" class="w-full bg-white border border-gray-300 rounded-md px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#4E6E6E]"/>
                    @error('number')
                        <span class="text-xs text-red-500">{{ $message }}</span>
                    @enderror
                </div>
